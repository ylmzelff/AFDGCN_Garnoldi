...
class GPRGNN(torch.nn.Module):
    def __init__(self, num_node, input_dim, output_dim, hidden, cheb_k, num_layers, embed_dim):
        ...
        self.lin1 = Linear(1728, 64)  # (hidden_dim*num_nodes, hidden_dim) 19, 1
        self.lin2 = Linear(64, 1728)
...
class APPNP_Net(torch.nn.Module):
    def __init__(self, num_node, input_dim, output_dim, hidden, cheb_k, num_layers, embed_dim):
        ...
        self.lin1 = Linear(1728, 64)  # (1728, 64) for Tuna
        self.lin2 = Linear(64, 1728)
    ...
    def forward(self, x):
        ...
        # (5, 1, 8, 64) for Konya
        x = x.reshape(x.size(0), 1, 27, 64)  # Manually reshape to (5, 1, 27, 64)
