...
pred_data_path = '/content/drive/MyDrive//test_results_after_predcsv.csv'
...
time_interval = 5 #5 # Time interval in minutes
...
zoom_start_date = pd.Timestamp("2025-02-12 00:00")
zoom_end_date = pd.Timestamp("2025-02-13 00:00")
    # Modify this
